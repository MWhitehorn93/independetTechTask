...
describe('Log in test', () => {
  it('Log in test', () => {
    ...
    .contains('Submit')
    .click()
    //The main banner is select and a max timeout is used to grab the test username
    cy.get('.sc-1pkogcm-1')
    .contains(nametest, { timeout: maxTimeout})
    //final step is to check the cookie 'loggedIn' has a value of true
    cy.getCookie('loggedIn', 'true')
